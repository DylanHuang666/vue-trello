    ...
    <div class="popup">
      <div class="popup-header">
        <div class="popup-title">
          ...
          <div class="popup-title-detail">在{{list.name}}列表中</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    setCover(id) {
      let coverPath =  this.card.attachments.find(v => v.id == id).path
      try {
...
<style scoped>
    .description .form-field-input{
        border:1px solid #999;
    }
    .description .form-field-input:focus{
        border:none;
    }
</style>
